    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: "hello", translation: "salve" },
            { original: "goodbye", translation: "vale" },
            { original: "name", translation: "nomine" },
            { original: "what", translation: "quid" },
            { original: "how", translation: "quam" },
